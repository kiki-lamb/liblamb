#ifndef kl_512_uint16_t_sin_h
#define kl_512_uint16_t_sin_h

#define KL_512_uint16_t_sin_cells 512

namespace lamb {
  namespace tables {
    namespace sin512_uint16_t {
...
PROGMEM
      ...
      = {
         ...
         42279,    42663,    43046,    43427,    43807,    44184,    44560,    44935, // 31
    
         45307,    45678,    46046,    46413,    46777,    47140,    47500,    47858, 
         48214,    48567,    48919,    49267,    49613,    49957,    50298,    50636, 
         50972,    51305,    51635,    51963,    52287,    52609,    52927,    53243, 
         53555,    53864,    54170,    54473,    54773,    55069,    55362,    55652, // 63
    
         55938,    56220,    56499,    56775,    57047,    57315,    57579,    57840, 
         58097,    58350,    58600,    58845,    59087,    59324,    59558,    59787, 
         60013,    60234,    60451,    60664,    60873,    61078,    61278,    61474, 
         61666,    61853,    62036,    62215,    62389,    62559,    62724,    62885, // 95
    
         63041,    63192,    63339,    63482,    63620,    63753,    63881,    64005, 
         64124,    64238,    64348,    64453,    64553,    64648,    64739,    64825, 
         64905,    64981,    65053,    65119,    65180,    65237,    65289,    65335, 
         65377,    65414,    65446,    65473,    65496,    65513,    65525,    65533, // 127
         ...
         64124,    64005,    63881,    63753,    63620,    63482,    63339,    63192, // 159
         ...
         58097,    57840,    57579,    57315,    57047,    56775,    56499,    56220, // 191
         ...
         48214,    47858,    47500,    47140,    46777,    46413,    46046,    45678, // 223
         ...
         35979,    35579,    35178,    34777,    34375,    33974,    33572,    33170, // 255
         ...
         23256,    22872,    22489,    22108,    21728,    21351,    20975,    20600, // 287
